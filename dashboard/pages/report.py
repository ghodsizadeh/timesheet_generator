...
fields = html.Div(
    [
        dbc.Input(id="report_last_name", placeholder="Type lastname", type="date"),
        dbc.Input(id="report_id", placeholder="Type report_id", type="number"),
    ],
    style={"width": "300px"},
)
layout = html.Div(
    [
        fields,
        dbc.Button("Find", id="report_find", color="secondary", className="mr-1",n_clicks= 0),
        dbc.Button("Create", id="report_create", color="primary", className="mr-1", n_clicks =0),
        html.Div(id="report_result_1"),
        html.Div(id="report_result_2"),
